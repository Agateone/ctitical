...
public void Registration7() throws InterruptedException {	
		...
		driver_Register_Page_Elements.findElement(Register_Page_Card_Expiry_Date).sendKeys("0923");
		driver_Register_Page_Elements.switchTo().defaultContent();		
		...
		driver_Register_Page_Elements.findElement(Register_Page_cvv).sendKeys("912");
		driver_Register_Page_Elements.switchTo().defaultContent();	
		...
		driver_Register_Page_Elements.switchTo().defaultContent();			
		Thread.sleep(4000);
		driver_Register_Page_Elements.findElement(First_name).sendKeys("Anne");
		Thread.sleep(4000);
		driver_Register_Page_Elements.findElement(Last_name).sendKeys("Silberbauer");
		Thread.sleep(4000);
		driver_Register_Page_Elements.findElement(Phone_number).sendKeys("07909684976");
		Thread.sleep(4000);
		driver_Register_Page_Elements.findElement(Address_line).sendKeys("42 Ellesmere Road");
		Thread.sleep(4000);
